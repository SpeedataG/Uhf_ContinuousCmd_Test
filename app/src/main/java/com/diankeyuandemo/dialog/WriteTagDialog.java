...
public class WriteTagDialog extends Dialog implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Write_Content.setText(DataConversionUtils.byteArrayToString(result));
        Write_Addr.setText("2");
//        Write_Addr.setFocusable(false);
//        Write_Count.setFocusable(false);
//        Write_Passwd.setFocusable(false);
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (RECE_DATA_ACTION.equals(intent.getAction())) {
                ...
                Write_Count.setText(DataConversionUtils.hexStringToByteArray(data).length / 2 + "");
            }
        }
    };
